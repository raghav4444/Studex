  ...
  const steps = [
    {
      ...
      description: 'Create your account using your verified .edu or .ac.in email address.',
      step: '01'
    },
    {
      icon: Shield,
      title: 'Get Verified',
      description: 'We verify your student status to ensure a trusted community.',
      step: '02'
    },
    {
      icon: Users,
      title: 'Connect & Network',
      description: 'Find peers, mentors, and study groups in your college and beyond.',
      step: '03'
    },
    {
      icon: BookOpen,
      title: 'Share & Learn',
      description: 'Upload notes, join discussions, and grow together as a community.',
      step: '04'
    }
  ];
    ...
    <section id="how-it-works" className="py-20 bg-[#161b22]">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-white mb-4">How CampusLink Works</h2>
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Getting started is simple. Join thousands of students already using CampusLink 
